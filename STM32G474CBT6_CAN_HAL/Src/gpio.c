...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : KEY_UP_Pin KEY_DOWN_Pin KEY_FORWARD_Pin KEY_BACKWARD_Pin */
  GPIO_InitStruct.Pin = KEY_UP_Pin|KEY_DOWN_Pin|KEY_FORWARD_Pin|KEY_BACKWARD_Pin;
